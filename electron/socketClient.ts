...
export default function socketClient(mainWindow: any) {
  let socket = io.connect("http://ec2-13-125-208-218.ap-northeast-2.compute.amazonaws.com:8828", {// http://ec2-13-125-208-218.ap-northeast-2.compute.amazonaws.com:8828
