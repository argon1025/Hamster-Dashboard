...
class Node extends React.Component<NodeProps> {
  ...
  render() {
    ...
    if (this.props.index % 2 === 0) {
      bgcolor = "border-b border-gray-200 hover:bg-blue-50";
    } else {
      bgcolor = "border-b border-gray-200 bg-gray-100 hover:bg-blue-50";
    }
    return (
      <tr className={bgcolor}>
        <td className="py-3 pl-7 text-left whitespace-nowrap">
          {this.props.index}
        </td>
        ...
        <td className="py-3 px-6 text-center">
          <div className="flex item-center justify-center">
            {/* file Download */}
            <div
              onClick={this.userFileDownloadButton}
            ...
            {/* command Run */}
            <div
              onClick={this.userCommandRunButton}
              className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            {/* shutdown */}
            <div
              onClick={this.userShutdownButton}
              className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
